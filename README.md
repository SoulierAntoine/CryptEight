...
+ Le client créé une clé composée de 5 lettres aléatoires et l'envoi au serveur.  
+ Le serveur créé également sa clé aléatoire, la concatène avec celle du client, et renvoi le tout.  
+ Le client et le serveur partage ainsi une clé mutuelle. Les échanges peuvent commencer.
...
+ Les échanges sont ainsi sécurisé avec un premier échange de clés mutuelles et un renouvellement de clé à chaque envoi de message.  
